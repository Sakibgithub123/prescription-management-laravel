...
<div class="sidebar" id="sidebar">
    <div class="sidebar-inner slimscroll bg-primary">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul class="text-white">
            <li class="menu-title font-weight-bold text-white h5 text-center border-bottom">Manage MediCareOPS</li>
                ...
                <li class="{{Route::is('profile')? 'active' : ''}}">
                    <a href="{{route('profile')}}"><i class="fa fa-user-md"></i> <span>My Profile</span></a>
                </li>
                <li class="{{Route::is('patientdetails')? 'active' : ''}}">
                    <a href="{{route('patientdetails')}}"><i class="fa fa-wheelchair"></i> <span>My Patients List</span></a>
                </li>
